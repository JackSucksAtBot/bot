...
module.exports = class SpinCommand extends JackBotHandler.Command {
    constructor(client) {
        super(client, {
            name: "spin",
            group: "video memes",
    ...
    run(msg) {
        ...
        dbl.hasVoted(msg.author.id).then(voted => {
            if (voted) {
                ...
                .addField("⏱ File Upload", "**This video can take up to 10 seconds for Discord to process.**\nﾠ ﾠ")
                ...
                return msg.channel.send(`${msg.author}`, {
                    file: "http://cairo2k18.xyz/src/offsite/jackbot/spin.mp4" 
                });
            } else
