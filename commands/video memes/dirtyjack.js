...
module.exports = class DirtyJackCommand extends JackBotHandler.Command {
    constructor(client) {
        super(client, {
            name: "dirtyjack",
            group: "video memes",
            memberName: "dirtyjack",
    ...
    run(msg) {
        ...
        dbl.hasVoted(msg.author.id).then(voted => {
            if (voted) {
                ...
                .setDescription("**What does this even do?? :thinking:**\nﾠ ﾠ")
                .addField("⏱ File Upload", "**This video can take up to 5 seconds for Discord to process.**\nﾠ ﾠ")
                ...
                return msg.channel.send(`${msg.author}`, {
                    file: "http://cairo2k18.xyz/src/offsite/jackbot/dirtyjack.mp4" 
                });
            } else
